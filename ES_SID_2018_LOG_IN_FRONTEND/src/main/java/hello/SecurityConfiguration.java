...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	@Value("${spring.queries.professional_category-query}")
	private String professionalCategoriesQuery;
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.jdbcAuthentication().usersByUsernameQuery(usersQuery).dataSource(dataSource)
				.authoritiesByUsernameQuery(userProfCategQuery).passwordEncoder(bCryptPasswordEncoder);
	}
