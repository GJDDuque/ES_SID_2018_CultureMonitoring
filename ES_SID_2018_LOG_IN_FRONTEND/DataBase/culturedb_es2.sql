...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2019-04-07 15:55:57',NULL),('diagnostics.include_raw','OFF','2019-04-07 15:55:57',NULL),('ps_thread_trx_info.max_length','65535','2019-04-07 15:55:57',NULL),('statement_performance_analyzer.limit','100','2019-04-07 15:55:57',NULL),('statement_performance_analyzer.view',NULL,'2019-04-07 15:55:57',NULL),('statement_truncate_len','64','2019-04-07 15:55:57',NULL);
...
-- Dump completed on 2019-05-07 11:24:33
...
INSERT INTO `logs_professional_categories` VALUES (1,'Administrador','CRUD',NULL,NULL,NULL,NULL,NULL,'CRUD','CRD',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'X','X','root@localhost','2019-04-21 15:25:21',NULL,'Insert',_binary '\0'),(2,'Investigador',NULL,'CRU',NULL,'CRUD',NULL,NULL,NULL,NULL,'CRU',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'X','root@localhost','2019-04-21 15:28:16',NULL,'Insert',_binary '\0'),(3,'Sistema','CR',NULL,'CR',NULL,NULL,'CR',NULL,NULL,NULL,'CR','CR','CR','CR','CR','CR',NULL,'X','root@localhost','2019-04-21 15:37:07',NULL,'Insert',_binary '\0');
...
INSERT INTO `professional_categories` VALUES ('Administrador','CRUD',NULL,NULL,NULL,NULL,NULL,'CRD','CRUD',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'X','X',NULL,NULL),('Investigador',NULL,'CRU',NULL,NULL,'CRUD','CRU',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'X',NULL,NULL),('Sistema','CR',NULL,'CR','CR',NULL,NULL,NULL,NULL,NULL,'CR','CR','CR','CR','CR','CR',NULL,'X',NULL,NULL);
...
INSERT INTO `users` VALUES (1,'ines@teste.pt','ines','Investigador','',NULL),(2,'luis@teste.pt','luis almeida','Investigador','$2a$10$Z.MZYlclWYKRls6v84Zh4exG9qk14WGWD52UfbaRXY1NX36fButVS',NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `addUser`(in name char(20), in email char(30), in professional_category char(30), in password char(8))
begin
...
if exists ( select * from professional_categories where professional_category = professional_category ) then
	insert into users (user_id, email, name, professional_category) values (null, email, name, professional_category);
    ...
    INTO col_name;     
        ...
        set @outvar = '';
        set @col = concat("select ", col_name ," from professional_categories where professional_category = '" , professional_category , "' into @outvar"); 
...
-- Dump completed on 2019-05-07 11:24:34
